...
# 固定分笔（time, amount, sign, price）：覆盖各档位与买卖方向，供资金流测试
MOCK_TICKS: list[tuple[str, float, int, float]] = [
    ("09:31:00", 100_000, 1, 10.00),   # 10万 买
    ("09:31:05", 50_000, -1, 10.01),   # 5万 卖
    ("09:32:00", 200_000, 1, 10.02),   # 20万 买
    ("09:32:30", 30_000, -1, 10.01),   # 3万 卖
    ("09:33:00", 300_000, 1, 10.03),   # 30万 买
    ("09:33:30", 120_000, -1, 10.02),  # 12万 卖
]
